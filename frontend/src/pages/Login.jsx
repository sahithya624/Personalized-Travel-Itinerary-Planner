...
import { Mail, Lock, ArrowLeft, Globe, ArrowRight, Sparkles } from 'lucide-react'
      ...
      <div className="hidden md:flex md:w-1/2 bg-slate-900 relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-lg text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-white/5 border border-white/10 text-white/60 text-xs font-bold mb-8 backdrop-blur-md"
          >
            <Globe className="w-4 h-4 text-primary" /> EXPLORE THE WORLD
          </motion.div>
          <motion.h2
          ...
          <motion.p
            ...
            className="text-white/50 text-lg font-medium leading-relaxed"
          >
            Experience the future of travel planning with our AI-powered itinerary engine.
          </motion.p>
          ...
          >
            {[
              ...
              <div key={i} className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                ...
                <p className="text-[10px] font-black uppercase tracking-widest text-white/40">{stat.sub}</p>
              </div>
            ))}
          </motion.div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  ...
                  <Link to="#" className="text-xs font-bold text-primary hover:text-primary-dark">Forgot password?</Link>
                </div>
                <div className="relative group">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full btn-primary py-4 px-8 text-lg shadow-xl shadow-primary/20 flex items-center justify-center gap-3"
              >
